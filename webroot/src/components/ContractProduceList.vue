...
<template>
  <div>
  <el-card v-for="item in contractProduceList" :key="item.ID" class="item_card">
    ...
    <el-row class="item_row">
      <el-col span="2">钱包地址</el-col>
       <el-col span="22">{{item.maker}}</el-col>
    </el-row>
    <el-row class="item_row">
  ...
  <!-- <el-table :data="contractProduceList" style="width: 100%" :border="true">
    ...
    <el-table-column prop="maker" label="钱包地址">
    </el-table-column>
